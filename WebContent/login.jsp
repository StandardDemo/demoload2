					...
					<div class="login-div">
						...
						<div class="panel panel-primary" style="">
							<div class="panel-heading">
								<span><img src="images/key_PNG1174.png" height="20"
									width="20" /></span><b>Employee Management</b>
							</div>
							<div class="panel-body" style="padding-top: 27px">
								<form method="post" class="form-horizontal" action="UserServlet"
									role="form">
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id="txtUserId"
												name="userId" placeholder="Enter User Id Here" />
										</div>
									</div>
									<div class="form-group">
